...
// GPPG version 1.5.2
// Machine:  STEFAN1968
// DateTime: 2021-01-20 19:18:28
// UserName: Stefan
// Input file <ExpressionParser.gppg - 2020-05-26 22:10:49>
...
{
  // Verbatim content from ExpressionParser.gppg - 2020-05-26 22:10:49
#line 7 "ExpressionParser.gppg"
  // Empty.
#line default
  // End verbatim content from ExpressionParser.gppg - 2020-05-26 22:10:49
...
#line 174 "ExpressionParser.gppg"
                 {
      CurrentSemanticValue.integer_value = Start.MacroMap.ContainsKey(ValueStack[ValueStack.Depth-1].name) ? 1 : 0;
    }
#line default
        break;
...
#line 177 "ExpressionParser.gppg"
                                        {
      CurrentSemanticValue.integer_value = Start.MacroMap.ContainsKey(ValueStack[ValueStack.Depth-2].name) ? 1 : 0;
    }
#line default
        break;
